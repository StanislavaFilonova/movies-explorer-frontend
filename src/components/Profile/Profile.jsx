...
function Profile(props) {
    ...
    React.useEffect(() => {
        setRequestStatusText(props.message);
    }, [props.message]);
            ...
            >
                <div className='profile__input-box'>
                    ...
                    <input
                        ...
                        disabled={props.isProfileSending}
                    />
                </div>
                ...
                <div className='profile__links'>
                    <span className='profile__input-error'>{requestStatusText}</span>
                    <button
                        type='submit'
                        className={
                            `profile__link
                            ...
                            ${props.isProfileSending && "profile__link_disabled"}
                            `}
